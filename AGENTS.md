...
When Codex is the active front-end, Codex is the architect and final judge.
OpenCode Go is the default implementation/test/review workforce.

Codex must read `CLAUDE.md` too, because both front-ends share the same repository authority and safety rules.
